...
from gram_core.builtins.contexts import handler_contexts, job_contexts

if TYPE_CHECKING:
    from gram_core.application import Application
    from gram_core.builtins.dispatcher import AbstractDispatcher, HandlerDispatcher
...
class HandlerExecutor(BaseExecutor, Generic[P, R]):
    ...
    def __init__(self, func: Callable[P, R], dispatcher: Optional[Type["HandlerDispatcher"]] = None) -> None:
        if dispatcher is None:
            from gram_core.builtins.dispatcher import HandlerDispatcher
